...
public class UserMessageActivityTest extends ActivityInstrumentationTestCase2 {

    private Solo solo;

    public UserMessageActivityTest() {
    ...
    public void testUserMessageActivity() {
        ...
        solo.clickOnView(solo.getView(R.id.action_UserMessage));
        solo.waitForActivity(UserMessageActivity.class, 2000);
        solo.assertCurrentActivity("Wrong Activity", UserMessageActivity.class);
    }
}
